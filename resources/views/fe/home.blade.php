            ...
            <div class="ec-sidebar-wrap">
                ...
                <div class="ec-sidebar-block">
                    ...
                    <div class="ec-sb-block-content">
                        <ul>
                            <li>
                                <div class="ec-sidebar-block-item"><img src="frontend/assets/images/icons/cosmetics-8.png"
...
<div class="sticky-header-next-sec ec-main-slider section section-space-pb">
        <div class="ec-slider swiper-container main-slider-nav main-slider-dot">
            ...
            <div class="swiper-wrapper">
                <div class="ec-slide-item swiper-slide d-flex" style="width: 100%;
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/assets/images/product-image/10_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/assets/images/product-image/10_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        ...
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="frontend/assets/images/product-image/10_3.jpg"
                                                                data-src-hover="frontend/assets/images/product-image/10_3.jpg"
                                                                data-tooltip="Green"><span
                                                                    style="background-color:#db94f7;"></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="frontend/assets/images/product-image/10_4.jpg"
                                                                data-src-hover="frontend/assets/images/product-image/10_4.jpg"
                                                                data-tooltip="Sky Blue"><span
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/assets/images/product-image/9_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/assets/images/product-image/9_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/assets/images/product-image/11_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/assets/images/product-image/12_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/assets/images/product-image/13_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/assets/images/product-image/14_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/assets/images/product-image/14_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <a href="#" class="quickview" data-link-action="quickview"
                                                    title="Quick view" data-bs-toggle="modal"
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/assets/images/product-image/15_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/assets/images/product-image/15_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/assets/images/product-image/16_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/assets/images/product-image/16_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="new">New</span>
                                    ...
                                    <div class="ec-product-inner">
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image"
                                                        src="{{ asset('frontend/assets/images/product-image/17_1.jpg') }}" alt="Product" />
                                                    <img class="hover-image"
                                                        src="{{ asset('frontend/assets/images/product-image/17_2.jpg') }}" alt="Product" />
                                                </a>
                                                <span class="percentage">20%</span>
                                                <span class="flags">
                                                    <span class="sale">Sale</span>
