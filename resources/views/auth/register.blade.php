                     ...
                     <div class="ec-flex">
                         ...
                         <div class="align-self-center">
                             <div class="header-logo">
                                 <a href="{{ route('home') }}"><img src="{{ asset('admin/assets/img/deba-logo.png') }}"
                                         ...
                                         <li>
                                             <ul class="ec-main-banner w-100">
                                                 <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img
                                                             ...
                                                             src="frontend/assets/images/menu-banner/1.jpg"
                                                             alt=""></a>
                                                 </li>
                                                 <li><a class="p-0" href="shop-left-sidebar-col-4.html"><img
                                                             class="img-responsive"
                                                             src="frontend/assets/images/menu-banner/2.jpg"
                                                             alt=""></a>
                                                 </li>
                                                 <li><a class="p-0" href="shop-right-sidebar-col-3.html"><img
                                                             class="img-responsive"
                                                             src="frontend/assets/images/menu-banner/3.jpg"
                                                             alt=""></a>
                                                 </li>
                                                 <li><a class="p-0" href="shop-right-sidebar-col-4.html"><img
                                                             class="img-responsive"
                                                             src="frontend/assets/images/menu-banner/4.jpg"
                                                             alt=""></a>
                                                 </li>
                                             </ul>
                                         </li>
                     ...
                     <ul>
                         ...
                         <li><a href="javascript:void(0)">Categories</a>
                             <ul class="sub-menu">
                                 ...
                                 <li><a class="p-0" href="shop-left-sidebar-col-3.html"><img
                                             class="img-responsive" src="frontend/assets/images/menu-banner/1.jpg"
                                             alt=""></a>
                                 </li>
                             </ul>
                         </li>
                         ...
                         <div class="col-sm-12 col-lg-3 ec-footer-contact">
                             <div class="ec-footer-widget">
                                 <div class="ec-footer-logo"><a href="#"><img
                                             ...
                                             class="dark-footer-logo" src="{{ asset('admin/assets/img/deba-logo.png') }}"
